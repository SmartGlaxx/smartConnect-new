...
const replyMessage = async(e)=>{
   ...
   const replyUrl = `${API}/messages/reply/${_id}/${userId}/${username}/${otherUserId}/${otherUserUsername}`
...
const deleteSent = async(e, _id)=>{
    e.preventDefault()
    const {_id : userId , username} = currentUserParsed
   const deleteUrl = `${API}/messages/deletesent/${_id}`
...
const deleteReceived = async(e, _id)=>{
    e.preventDefault()
    const {_id : userId , username} = currentUserParsed
   const deleteUrl = `${API}/messages/deletereceived/${_id}`
